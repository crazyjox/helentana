{% if m.account.is_online %}
    <div class="well">
       <div style="text-align:center;">
    		Приветствую тебя, <br/>
	    	<strong>{{ m.account.email }}</strong> <br/><br/>
            {% button text="Войти в мир Элентаны" postback={open_world} delegate="helentana_account" class="btn" %}
...
{% else %}
    <div class="well">
        <div style="text-align:center;">
            {% wire id="quick-login-form" type="submit" postback={login_account} delegate="helentana_account" %}
